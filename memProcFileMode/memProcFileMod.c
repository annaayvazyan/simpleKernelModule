...
MODULE_DESCRIPTION("Module which defines functions which will be used by other modules to demonstrate symbol exporting");
...
static int simple_init(void)
{
	...
	ent=proc_create("AnnasMemDev", 0666, NULL, &myops);
